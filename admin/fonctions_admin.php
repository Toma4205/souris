...
function calculer_confrontations_journee($constante_num_journee_cal_reel, $ligue_unique)
{
...
function mise_a_jour_stat_classement($constante_num_journee_cal_reel)
{
