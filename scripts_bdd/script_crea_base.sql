...
CREATE TABLE `ami` (`id_coach` MEDIUMINT UNSIGNED NOT NULL , `id_coach_ami` MEDIUMINT UNSIGNED NOT NULL , `date_ajout` DATETIME NULL , `date_refus` DATETIME NULL , PRIMARY KEY (`id_coach`, `id_coach_ami`)) ENGINE = InnoDB;
