...
CREATE TABLE nomenclature_bonus_malus (`code` VARCHAR(30) NOT NULL , `libelle_court` VARCHAR(30) NOT NULL , `libelle` VARCHAR(255) NOT NULL, `select_joueur` BOOLEAN NOT NULL , `date_debut` DATE NOT NULL , `date_fin` DATE NULL , PRIMARY KEY (`code`)) ENGINE = InnoDB;
