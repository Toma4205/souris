...
('DEPENSIER','Le dépensier', 'Le coach qui a le plus de joueurs qui n\'ont jamais été notés.', '2017-01-01'),
('ECONOME','L\'économe', 'Le coach qui a le plus gros budget restant.', '2017-01-01'),
('VOYANT','Le voyant', 'Le coach qui a trouvé un joueur au 3ème tour mercato (ou plus) et qui est dans le top 10 des buteurs.', '2017-01-01'),
