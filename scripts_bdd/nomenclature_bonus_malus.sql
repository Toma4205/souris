INSERT INTO `nomenclature_bonus_malus`(`code`, `libelle`, `select_joueur`, `date_debut`) VALUES
...
('CHA_GB','Parce que ton gardien a passé plus de temps avec Ahamada que Neuer (remplacement tactique possible sur ton GB)', TRUE ,'2017-01-01'),
('PAR_TRU','Pari truqué (buts doublés pour un joueur sur une mi-temps)', TRUE ,'2017-01-01'),
('CON_ZZ','Les conseils de Zizou profitent à tout footballeur (+0.5 équipe)', FALSE ,'2017-01-01');
