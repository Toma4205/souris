...
class CompoEquipeManager extends ManagerBase
{
  ...
  {
    $q = $this->_bdd->prepare('SELECT ce.*, jr.nom as nomJoueurReelEquipe,
      jr2.nom as nomJoueurReelAdverse, bm.mi_temps as miTemps, n.libelle_court as libCourtBonusMalus,
  ...
  public function findJoueurCompoByCompo($idCompo)
  {
    ...
    $q = $this->_bdd->prepare('SELECT jce.*, jr.nom, jr.position, jr2.nom as nom_remplacant, 
      jr2.prenom as prenom_remplacant
